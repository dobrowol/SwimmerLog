...
package dobrowol.swimmerlog.authenticator;
...
import dobrowol.swimmerlog.Constants;
import dobrowol.swimmerlog.client.NetworkUtilities;
 ...
 * AuthenticatorFragment intent and return that. That will display the dialog
...
class Authenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType,
        ...
        final Intent intent = new Intent(mContext, AuthenticatorFragment.class);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account,
        ...
        // an intent to display our AuthenticatorFragment panel.
        final Intent intent = new Intent(mContext, AuthenticatorFragment.class);
        intent.putExtra(AuthenticatorFragment.PARAM_USERNAME, account.name);
        intent.putExtra(AuthenticatorFragment.PARAM_AUTHTOKEN_TYPE, authTokenType);
        intent.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
        final Bundle bundle = new Bundle();
        bundle.putParcelable(AccountManager.KEY_INTENT, intent);
        return bundle;
